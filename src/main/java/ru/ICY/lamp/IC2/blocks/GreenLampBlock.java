...
import ru.ICY.lamp.IC2.TileEntities.GreenLampICTileEntity;
...
public class GreenLampBlock extends BlockContainer {
    protected static final AxisAlignedBB FULL_AABB = new AxisAlignedBB(0D, 0D, 0D, 1D, 1D, 1D);
    public GreenLampBlock(String name, Material material, CreativeTab tab, float lightLevel) {
        this(name,material,lightLevel);
        this.setCreativeTab(tab);
    }
    public GreenLampBlock(String name, Material material, float lightLevel) {
        super(material);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new GreenLampICTileEntity();
    }
    @Override
