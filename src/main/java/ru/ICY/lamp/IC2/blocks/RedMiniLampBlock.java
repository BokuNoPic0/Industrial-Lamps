...
import ru.ICY.lamp.IC2.TileEntities.RedMiniLampICTileEntity;
...
public class RedMiniLampBlock extends BlockContainer{// BlockContainer block
    ...
    public RedMiniLampBlock(String name, CreativeTab tab, float lightLevel) {
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new RedMiniLampICTileEntity(getStateFromMeta(meta).getValue(FACING));
    }
    @Override
