...
import ru.ICY.lamp.IC2.TileEntities.BlueLampICTileEntity;
...
public class BlueLampBlock extends BlockContainer {
    protected static final AxisAlignedBB FULL_AABB = new AxisAlignedBB(0D, 0D, 0D, 1D, 1D, 1D);
    public BlueLampBlock(String name, Material material, CreativeTab tab, float lightLevel) {
        this(name,material,lightLevel);
        this.setCreativeTab(tab);
    }
    public BlueLampBlock(String name, Material material, float lightLevel) {
        super(material);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new BlueLampICTileEntity();
    }
    @Override
