...
import ru.ICY.lamp.IC2.TileEntities.PurpleLampICTileEntity;
...
public class PurpleLampBlock extends BlockContainer {
    protected static final AxisAlignedBB FULL_AABB = new AxisAlignedBB(0D, 0D, 0D, 1D, 1D, 1D);
    public PurpleLampBlock(String name, Material material, CreativeTab tab, float lightLevel) {
        this(name,material,lightLevel);
        this.setCreativeTab(tab);
    }
    public PurpleLampBlock(String name, Material material, float lightLevel) {
        super(material);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new PurpleLampICTileEntity();
    }
    @Override
