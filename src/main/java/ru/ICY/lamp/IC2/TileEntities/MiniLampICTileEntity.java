...
public class MiniLampICTileEntity extends CustomSink implements ITickable{
    EnumFacing facing=null;
    public MiniLampICTileEntity(EnumFacing facing) {
        super(ModMain.miniLampCapacity,1);
        this.facing=facing;
    }
    public MiniLampICTileEntity() {
        super(ModMain.miniLampCapacity,1);
    }
    @Override
    public void update() {
        ...
        if(this.energyBuffer.getEnergyStored()>=price){
            ...
            if(this.world.getBlockState(this.pos).getBlock() == ModMain.CustomBlocks.mini_lamp_off){
            ...
            if(this.world.getBlockState(this.pos).getBlock() == ModMain.CustomBlocks.mini_lamp_on){
        ...
        if(te!=null && te!=this && te instanceof MiniLampICTileEntity){
            ((MiniLampICTileEntity)te).energyBuffer.setEnergyStored(this.energyBuffer.getEnergyStored());
        }
    }
